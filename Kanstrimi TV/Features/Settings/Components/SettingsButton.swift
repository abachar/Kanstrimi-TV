...
struct SettingsButton: View {
    ...
    var body: some View {
        Button(action: action) {
            ...
            .foregroundColor(isFocused ? .kanOverlayText : style.textColor)
    ...
    enum ButtonStyle {
        ...
        var backgroundColor: Color {
            switch self {
            case .primary: return .kanTabSelected
            case .secondary: return .kanCardBackground
            case .destructive: return .kanError.opacity(0.2)
            }
        }
        ...
        var focusedBackgroundColor: Color {
            ...
            case .primary: return .kanTabSelected
            case .secondary: return .kanCardBackground
            case .destructive: return .kanError
            }
        }

        var textColor: Color {
            switch self {
            case .primary: return .kanOverlayText
            case .secondary: return .kanTextPrimary
            case .destructive: return .kanError
            }
        }
    }
